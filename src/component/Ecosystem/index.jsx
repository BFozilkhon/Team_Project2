        ...
        {data.map((value) => {
          return (
            <CardAni.Container key={value.id}>
              ...
              <CardAni.HeaderBlack>{value.headerBlack}</CardAni.HeaderBlack>
              <CardAni.HeaderLight>{value.headerLight}</CardAni.HeaderLight>
              <CardAni.Text>{value.text}</CardAni.Text>
            </CardAni.Container>
          );
        })}
      </CardAni>
